...
public actual fun exportQRCodeImage(
    ...
    SwingUtilities.invokeLater {
        val frame = Frame()
        val dialog = FileDialog(frame, "Save QR Code Image", FileDialog.SAVE)
